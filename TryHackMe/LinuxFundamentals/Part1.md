...
find, wc (count entries), grep (search for value)
Use grep on "access.log" to find the flag that has a prefix of "THM". What is the flag? Note: The "access.log" file is located in the "/home/tryhackme/" directory. -THM{ACCESS}
